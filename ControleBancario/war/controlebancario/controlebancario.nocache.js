...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "controlebancario" because\n';
  ...
  $wnd.__gwt_activeModules['controlebancario'] = {
    'moduleName' : 'controlebancario',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/controlebancario.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['controlebancario'].superdevmode = true;

  var expectedSuffix = '/controlebancario.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + controlebancario + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:controlebancario';
  var devModeSessionKey = '__gwtDevModeSession:controlebancario';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/controlebancario/controlebancario.nocache.js';
  ...
  $wnd.__gwt_activeModules['controlebancario'].canRedirect = true;
  $wnd.__gwt_activeModules['controlebancario'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING controlebancario';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/controlebancario?user.agent=' + ua + '&_callback=' + callback;
